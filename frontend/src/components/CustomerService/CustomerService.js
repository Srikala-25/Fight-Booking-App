        ...
        <div className="column3">
          <div className="seatInfo">
            ...
            <center>
              ...
              <center>
                <br />
                <p class="te">EMAIL: flyoraairlines@gmail.com</p>
                <p class="te">CONTACT NUMBER: 9704857394</p>
                <p class="te">ADDRESS:91-Z/19,HYDERABAD,110001 </p>
              </center>
            </center>
            <br />
            <br />
